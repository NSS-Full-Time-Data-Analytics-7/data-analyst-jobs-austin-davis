...
Tableau developer, data visualization, & PM/BA*/
SELECT COUNT(title)
FROM data_analyst_jobs
...
Find the number of jobs by industry (domain) that require SQL and have been posted longer than 3 weeks. 
 ...
 - Which three industries are in the top 4 on this list? Insurance, Health Care, & Restaurants, Travel, & Leisure
...
SELECT COUNT(domain)
FROM data_analyst_jobs
WHERE domain = 'Restaurants, Travel and Leisure'
